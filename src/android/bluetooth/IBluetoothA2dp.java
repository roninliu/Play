 ...
 * Original file: D:\\Android\\workspace\\QrobotMini_trunk\\src\\android\\bluetooth\\IBluetoothA2dp.aidl
 */
...
@Override public boolean connectSinkInternal(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean disconnectSinkInternal(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean allowIncomingConnect(android.bluetooth.BluetoothDevice device, boolean value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
